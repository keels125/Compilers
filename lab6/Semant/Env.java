...
class Env {
  ...
  Env(ErrorMsg.ErrorMsg err) {
    ...
    NAME INTARRAY = new NAME(sym("_intarray"));
    INTARRAY.bind(Semant.INTARRAY);
    tenv.put(sym("_intarray"), INTARRAY);
    ...
    venv.put(sym("printArray"), FunEntry(RECORD(sym("a"), INTARRAY), VOID));
  }
}
