...
public class Semant {
  ...
  static final Types.ARRAY  INTARRAY = new Types.ARRAY(INT);
  ...
  private Utils.BoolList escapes(Absyn.FieldList f) {
    if (f == null)
      return null;
    return new Utils.BoolList(f.escape, escapes(f.tail));
  }
